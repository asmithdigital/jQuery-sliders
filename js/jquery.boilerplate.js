...
;( function( $, window, document, undefined ) {
  ...
  $.extend( Plugin.prototype, {
    init: function() {
      ...
      var slide_count = ul.children().length; // array of slides
      var slide_width = slide_count * 100.00; // sets the UL width to a multiple of each slide * 100%
      var slide_height = 400; // max height of the slide images
      var new_slide_height = slide_height;
      var thumb_height = slide_height;
      var slide_width_pc = 100.0 / slide_count; // % width of each slide
      var slide_index: // will be used to define the active slide
      var first_slide = ul.find("li:first-child");
      var last_slide = ul.find("li:last-child");
      var thumbsArray = []; // initially empty thumbs array

      var previous_button_class = opts.previous_button_class;
      var next_button_class = opts.next_button_class;
      var thumbs_class = opts.thumbs_class;
      var max_slide_thumbs = opts.max_slide_thumbs; // will decide the widths of each thumb
      var active_class = opts.active_class;
    ...
    slide: function(new_slide_index) {
      ...
      ul.animate({"margin-left": margin_left_pc}, 400, function() {
        ...
        self.setting.slide_index = new_slide_index;
    ...
    styleActiveThumb: function(newIndex) {
